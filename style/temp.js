...
let scriptId;
let id_tings = 124;
OpenedNode = { e: true, node: null, a: 0.8, x: 0, y: 0, lastX: 0, lastY: 0, isPressed: false }
...
function setNewUI() {
    ...
    Bind.addChild(new Field({ type: 'setkey', label: 'Set AutoExtractorPut', property: 'k', object: Settings.AutoExtractorPut, action: data => { kasdgiksadg.controls.setKeyBind('AutoExtractorPut'); } }));
    Bind.addChild(new Field({ type: 'setkey', label: 'Set AutoExtractorTake', property: 'k', object: Settings.AutoExtractorTake, action: data => { kasdgiksadg.controls.setKeyBind('AutoExtractorTake'); } }));
    ...
    Map.addChild(new Field({ type: 'checkbox', label: 'Show map', object: Settings.miniMap, property: 'e', onChange: data => { kasdgiksadg.saveSettings(); } }));
    ...
    UI.addChild(new Field({ type: 'range', label: 'Opacity', min: 0.1, max: 1, step: 0.05, object: Settings.fastOpenUI, property: 'o', onChange: data => { kasdgiksadg.saveSettings(); } }));
